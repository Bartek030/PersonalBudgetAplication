			...
			<section>
				<div id="mainContainer" class="row px-5 py-4">
					...
					<div class="col-md-6 d-grid text-center">
						<span class="fs-4 m-2">Aby rozpocząć:</span>
						<a href="login.php"><button type="button" class="btn btn-lg fw-bold fs-4 my-2 mx-auto greenButton">ZALOGUJ SIĘ</button></a>
						<span class="fs-4 m-2">Lub jeśli nie masz jeszcze konta:</span>
						<a href="registry.php"><button type="button" class="btn btn-lg fw-bold fs-4 my-2 mx-auto greenButton">ZAREJESTRUJ SIĘ</button></a>
					</div>
				</div>
			</section>
		</main>
